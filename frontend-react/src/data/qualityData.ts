export const qualityData = {
  ...
  "total_recorded_runs": 75,
  "metric_methodology": {
    "correctness": "Expected-fact coverage using normalized lexical overlap. A fact is supported when answer/fact token overlap is >= 0.60. This is a heuristic proxy and not a substitute for human semantic review.",
    "response_relevance": "Question-answer token overlap: >=0.50 = full relevance, >=0.25 = partial relevance, otherwise zero.",
    "retrieval_evidence_hit_rate": "Number of retrieved chunks containing lexical support for at least one expected fact divided by retrieved chunks.",
    "retrieval_gold_coverage": "Retrieved gold source/page locations divided by the number of gold source/page locations specified in the rubric, capped at 100%.",
    "hallucination_signal_rate": "Rate of answers triggering conservative unsupported-claim patterns. This is a screening signal, not a confirmed hallucination rate.",
    "composite_test_pass_rate": "Successful generation plus correctness >=60%, relevance >=50%, and at least one retrieval chunk with evidence support. Q25 requires abstention.",
    "latency": "Wall-clock generation latency recorded by the evaluation runner.",
    "token_usage": "Prompt, output, and total tokens returned by Ollama.",
    "resource_usage": "Evaluator-process CPU percentage snapshots and memory delta. These are not isolated Ollama model resource measurements.",
    "ai_output_testing": "Independent pass/fail checks covering relevance, retrieved-context support, unsupported-claim screening, expected format, answering when information exists, and abstention when information is unavailable."
  },
  "models_results": {
    "deepseek-coder:1.3b": {
      "question_count": 25,
      "generation_success_rate_percent": 96.0,
      "average_correctness_percent": 21.53,
      "average_response_relevance_percent": 82.0,
      "retrieval": {
        "average_evidence_hit_rate_percent": 85.33,
        "average_gold_coverage_percent": 24.03,
        "note": "Retrieval is produced by the shared Week 3 retrieval service using the same knowledge base and top-k condition for all three models."
      },
      "hallucination_signal_rate_percent": 8.0,
      "composite_test_pass_rate_percent": 12.0,
      "ai_output_testing": {
        "pass_rate_percent": 44.0,
        "passed": 11,
        "total": 25
      },
      "performance": {
        ...
        "evaluator_process_cpu_percent_snapshot": {
          ...
          "note": "CPU percentage snapshots are measurements of the evaluation process, not isolated Ollama model CPU usage."
        },
        "evaluator_process_memory_delta_mb": {
          "mean": 0.0094,
          "median": 0.0039,
          "min": 0.0,
          "max": 0.0625,
        ...
        "resource_note": "Resource values were collected by the evaluation process. They should not be interpreted as direct isolated model resource consumption."
      },
      "questions": [
        {
          "question_id": 1,
          ...
          "retrieval": {
            ...
            "gold_coverage": 0.3333,
            "gold_locations_retrieved": 2,
            "gold_locations_expected": 6,
            "chunks": [
              {
                "source": "UIAI_1.pdf",
                "page": 9,
                ...
                "gold_location": true,
                "contains_expected_fact_signal": true,
                "supporting_facts": [
                  {
          ...
          "composite_test_pass": false,
          "ai_output_testing": {
            "pass": true,
            "checks": {
              "relevance": true,
              "supported_by_retrieved_context": true,
              "unsupported_claim_screen": true,
              "expected_format": true,
              "answer_when_information_exists": true,
              "refuse_when_information_unavailable": true
            },
        ...
        },
        {
          ...
          "retrieval": {
            ...
            "evidence_hit_rate": 1.0,
            "gold_coverage": 0.25,
            "gold_locations_retrieved": 1,
            "gold_locations_expected": 4,
            "chunks": [
              {
                "source": "UIAI_1.pdf",
                "page": 8,
        ...
        },
        {
          ...
          "retrieval": {
            "top_k": 3,
            "retrieved_chunks": 3,
            "evidence_hit_rate": 0.6667,
            "gold_coverage": 0.3333,
            "gold_locations_retrieved": 1,
            "gold_locations_expected": 3,
            "chunks": [
              {
                "source": "UIAI_1.pdf",
                "page": 13,
              ...
              },
              {
                ...
                "gold_location": false,
                "contains_expected_fact_signal": false,
                "supporting_facts": [],
          ...
          "fact_details": [
            {
              "fact": "Aadhaar provides a portable proof of identity.",
              "overlap": 0.6,
              "supported": true
            },
            {
        ...
        },
        {
          ...
          "ai_output_testing": {
            ...
            "reason": "One or more output checks failed"
          },
          "fact_details": [
            {
              "fact": "Proof of Identity (POI) is an identity document accepted by UIDAI for establishing the resident's identity during Aadhaar enrolment or update.",
        ...
        },
        {
          ...
          "fact_details": [
            {
              "fact": "Photograph is collected.",
              "overlap": 0.5,
              "supported": false
            },
            {
              "fact": "Fingerprints are collected.",
              "overlap": 1.0,
              "supported": true
            },
            {
              "fact": "Iris scans are collected.",
              "overlap": 0.3333,
              "supported": false
            },
            {
              "fact": "For children, fingerprints, iris scans and photographs are captured during mandatory biometric updates.",
              "overlap": 0.4,
              "supported": false
            }
          ]
        ...
        },
        {
          ...
          "fact_details": [
            ...
            {
              "fact": "Aadhaar can subsequently be downloaded or received as an Aadhaar letter when generated.",
              "overlap": 0.1667,
              "supported": false
            }
          ]
        ...
        },
        {
          ...
          "fact_details": [
            {
              "fact": "The verifier is involved in verification of the resident's enrolment/update information and supporting documentation.",
              "overlap": 0.2222,
              "supported": false
            },
            {
              "fact": "The enrolment/update form contains a verifier stamp and signature as part of the verification process.",
              "overlap": 0.2,
              "supported": false
            }
          ]
        },
        {
          ...
          "hallucination_signal": false,
          "generation_error": "HTTPConnectionPool(host='localhost', port=11434): Read timed out. (read timeout=300)",
          "composite_test_pass": false,
          "ai_output_testing": {
            "pass": false,
            "checks": {
    ...
    "llama3.2:3b": {
      "question_count": 25,
      "generation_success_rate_percent": 100.0,
      "average_correctness_percent": 29.33,
      "average_response_relevance_percent": 82.0,
      "retrieval": {
        "average_evidence_hit_rate_percent": 85.33,
        "average_gold_coverage_percent": 24.03,
      ...
      "hallucination_signal_rate_percent": 8.0,
      "composite_test_pass_rate_percent": 28.0,
      "ai_output_testing": {
        "pass_rate_percent": 48.0,
        "passed": 12,
        "total": 25
      },
      "performance": {
      ...
      "questions": [
        ...
        },
        {
          ...
          "fact_details": [
            {
              "fact": "Aadhaar generation occurs after enrolment information has been submitted and processed.",
              "overlap": 0.2,
              "supported": false
            },
            {
    ...
    "qwen2.5-coder:1.5b": {
      "question_count": 25,
      "generation_success_rate_percent": 100.0,
      "average_correctness_percent": 28.27,
      "average_response_relevance_percent": 82.0,
      "retrieval": {
        "average_evidence_hit_rate_percent": 85.33,
        "average_gold_coverage_percent": 24.03,
      ...
      "hallucination_signal_rate_percent": 4.0,
      "composite_test_pass_rate_percent": 20.0,
      "ai_output_testing": {
        "pass_rate_percent": 48.0,
        "passed": 12,
        "total": 25
  ...
  "shared_retrieval_pipeline": {
    "questions_analyzed": 25,
    "average_evidence_hit_rate_percent": 85.33,
    "average_gold_coverage_percent": 24.03,
    "condition": "Same Week 3 retrieval service, same knowledge base, same top_k=3 condition for all models.",
    "questions": [
      {
        "question_id": 1,
        "top_k": 3,
