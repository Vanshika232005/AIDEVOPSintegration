export const aiOutputData = {
  "evaluation_version": "ai_output_testing_v2",
  "input": "evaluation/results/rag_analysis_25_newmodels.json",
  "methodology": {
    "relevance": "Non-abstaining answers must contain meaningful terminology related to the question. Valid abstentions are treated as relevant responses.",
    "context_support": "When retrieved context is sufficient, the model must answer without an unsupported-claim signal. When retrieved context is insufficient, the model must abstain without an unsupported-claim signal.",
    "unsupported_claims": "The existing RAG analysis must not identify an unsupported-claim signal.",
    "format": "The output must be a non-empty string and must not contain obvious malformed or runtime-error output.",
    "expected_behavior": "If all expected facts are supported by retrieved context, the expected behavior is to answer. If required information is missing from retrieved context, the expected behavior is to abstain.",
    "overall_pass": "All five AI output criteria must pass.",
    "evaluation_scope": "The same 75 previously generated model responses were tested; no new LLM generation was performed."
  },
  "summary": {
    "total_outputs": 75,
    "overall_passed": 50,
    ...
    "behavior_pass_rate_percent": 74.67
  },
  "results": [
    {
      "question_id": 1,
